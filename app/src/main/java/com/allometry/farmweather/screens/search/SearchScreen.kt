package com.allometry.farmweather.screens.search
...
@Composable
fun CommonTextField(
    valueState: MutableState<String>, placeHosdler: String,
    KkeyboardType: KeyboardType = KeyboardType.Text,
    ...
    OutlinedTextField(
        ...
        label = { Text(text = placeHosdler) },
        maxLines = 1,
        singleLine = true,
        keyboardOptions = KeyboardOptions(keyboardType = KkeyboardType, imeAction = imeAction),
